// WishlistPreference Repository
const WishlistPreferenceModel = require('../../models/wishlist/wishlist-preference.model');
 ...
 * @class WishlistPreference Repository
 */
class WishlistPreferenceRepository {
    ...
    constructor() {
        //Logging Info
        this._classInfo = '*** [WishlistPreference].repository';
    }
    ...
    /**
     * Delete a WishlistPreference by id
     * @param {string} id WishlistPreference Id
     * @param {requestCallback} callback Handles the response
    ...
    delete(id, callback) {
        ...
        WishlistPreferenceModel.deleteOne({ _id: id })
            .then((data) => {
                callback(null, data);
            })
            .catch(error => {
    ...
    /**
     * Gets a single WishlistPreference 
     * @param {string} id WishlistPreference id
     * @param {requestCallback} callback Handles the response
    ...
    get(id, callback) {
        ...
        WishlistPreferenceModel.findById(
            id,
            null,
            {
                select: {
    ...
    /**
     * Inserts a Wishlist
     * @param {object} body WishlistPreference data
     * @param {requestCallback} callback Handles the response
    ...
    update(id, body, callback) {
        ...
        WishlistPreferenceModel.findOneAndUpdate(
            { _id: id },
            body,
            { new: true })
            .then(data => {
                //returns WishlistPreference data
                callback(null, data);
            })
            .catch(error => {
...
module.exports = new WishlistPreferenceRepository();
